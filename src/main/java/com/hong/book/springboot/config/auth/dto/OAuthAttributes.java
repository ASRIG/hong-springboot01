package com.hong.book.springboot.config.auth.dto;
...
public class OAuthAttributes {
    ...
    // User 엔티티를 생성한다. OAuthAttributes에서 엔티팉를 생성하는 시점은 처음 가입할 때이다.
    // 가입할 때, 기본권한을 GUSET로 주기 위해서 role 빌더값에 ROLE.GUEST를 사용한다.
